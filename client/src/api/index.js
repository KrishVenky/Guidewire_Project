...
export const createPolicy = (workerId) => api.post('/policies/create', {
  worker_id: workerId,
  terms_accepted: true,
  privacy_accepted: true,
  terms_version: 'v1',
  privacy_version: 'v1',
  consent_text_hash: 'hermetical_terms_privacy_v1',
  consent_source: 'WORKER_DASHBOARD',
})
export const getPolicy = (id) => api.get(`/policies/${id}`)
export const getPolicyConsentReceipt = (id) => api.get(`/policies/${id}/consent-receipt`)
...
export const getCommunicationPreferences = (workerId) => api.get(`/workers/${workerId}/communication-preferences`)
export const updateCommunicationPreferences = (workerId, data) => api.put(`/workers/${workerId}/communication-preferences`, data)
